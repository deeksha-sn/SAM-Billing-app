          ...
          <div className="bg-white rounded-2xl p-6 max-w-lg w-full shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="p-4 bg-emerald-50 hover:bg-emerald-100 rounded-xl flex flex-col items-center gap-2 border border-emerald-200 text-emerald-800 font-semibold transition"
              >
              ...
              <button
                ...
                className="p-4 bg-blue-50 hover:bg-blue-100 rounded-xl flex flex-col items-center gap-2 border border-blue-200 text-blue-800 font-semibold transition"
              >
              ...
              <button
                ...
                className="p-4 bg-purple-50 hover:bg-purple-100 rounded-xl flex flex-col items-center gap-2 border border-purple-200 text-purple-800 font-semibold transition"
              >
              ...
              <button
                ...
                className="p-4 bg-amber-50 hover:bg-amber-100 rounded-xl flex flex-col items-center gap-2 border border-amber-200 text-amber-800 font-semibold transition"
              >
              ...
              <button
                ...
                className="p-4 bg-indigo-50 hover:bg-indigo-100 rounded-xl flex flex-col items-center gap-2 border border-indigo-200 text-indigo-800 font-semibold transition"
              >
              ...
              <button
                ...
                className="p-4 bg-teal-50 hover:bg-teal-100 rounded-xl flex flex-col items-center gap-2 border border-teal-200 text-teal-800 font-semibold transition"
              >
