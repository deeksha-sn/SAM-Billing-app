    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 border border-red-200 animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
          ...
          <div>
            <h2 className="text-lg font-extrabold text-gray-900">Delete Delivery Challan?</h2>
        ...
        <div className="my-4 p-4 bg-red-50/70 border border-red-200 rounded-2xl space-y-2 text-xs">
          <div className="flex justify-between">
            <span className="text-gray-600 font-medium">Challan No:</span>
            <span className="font-bold font-mono text-red-900">{challan.challanNumber}</span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-bold font-mono text-gray-800">{challan.items?.length || 0} line items</span>
          </div>
        </div>
        ...
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-900 mb-6 leading-relaxed">
          ...
          {challan.affectsStock
            ? 'This permanently deletes this Delivery Challan and restores its stock deduction back to inventory.'
            : 'This permanently deletes this Delivery Challan record from the database.'}
        </div>
