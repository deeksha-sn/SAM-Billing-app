    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className="text-2xl font-black text-gray-900 font-mono">₹{s.todaySales.toLocaleString('en-IN')}</p>
        ...
        >
          <div className="flex justify-between items-center mb-3">
            <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Today's Purchases</span>
          ...
          <p className="text-2xl font-black text-gray-900 font-mono">₹{s.todayPurchases.toLocaleString('en-IN')}</p>
        ...
        >
          ...
          <p className="text-2xl font-black text-gray-900 font-mono">₹{s.todayCollections.toLocaleString('en-IN')}</p>
        ...
        >
          ...
          <p className="text-2xl font-black text-gray-900 font-mono">₹{s.todayExpenses.toLocaleString('en-IN')}</p>
        ...
        >
          ...
          <p className="text-2xl font-black text-amber-700 font-mono">₹{s.receivables.toLocaleString('en-IN')}</p>
        ...
        >
          ...
          <p className="text-2xl font-black text-slate-800 font-mono">₹{s.payables.toLocaleString('en-IN')}</p>
        ...
        >
          ...
          <p className="text-2xl font-black text-red-600 font-mono">{s.lowStockCount}</p>
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Monthly Financial Performance</h3>
            ...
            <div className="space-y-3">
              {data.topItems.map((item: any, idx: number) => (
                <div key={idx} className="p-3 bg-gray-50 rounded-xl flex justify-between items-center">
                  ...
                  <p className="font-bold font-mono text-sm text-gray-900">₹{item._sum.totalAmount.toLocaleString('en-IN')}</p>
                </div>
              ))}
            </div>
          ) : (
